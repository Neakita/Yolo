...
public sealed class ChanneledInputProcessor<TPixel> : InputProcessor<TPixel> where TPixel : unmanaged
{
	public ChanneledInputProcessor(params IReadOnlyCollection<byte> channelPositions)
	{
